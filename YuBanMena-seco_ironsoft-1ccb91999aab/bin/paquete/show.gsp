...
<html>
    ...
    <body>
        ...
        <div id="show-paquete" class="content scaffold-show" role="main">
            ...
            <f:display bean="paquete" />
            <g:form resource="${this.paquete}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.paquete}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
