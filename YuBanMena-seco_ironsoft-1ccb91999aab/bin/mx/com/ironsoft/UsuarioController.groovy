...
class UsuarioController {
    ...
    def ticket() {
        ...
        def datos = [
                numeroDeContrato: numContrato, fechaDeCreacion: new Date(),
                servicio: servicio, servicioDescripcion:descripcionDelServicio, paquete:paquete,
                paqueteDescripcion: descripcionDelPaquete, pagoRealizado:pago, usuarioNombre:nombreUsuario,
                usuarioApellidoP: apellidoPaterno, usuarioApellidoM:  apellidoMaterno, usuario: usuario
        ]
        flash.icon = "check"
