...
class ContratoControllerSpec extends Specification implements ControllerUnitTest<ContratoController>, DomainUnitTest<Contrato> {
    ...
    void "Test the save action with a null instance"() {
        ...
        response.redirectedUrl == '/contrato/index'
        flash.message != null
    }
    ...
    void "Test the save action correctly persists"() {
        ...
        controller.save(contrato)

        then:"A redirect is issued to the show action"
        response.redirectedUrl == '/contrato/show/1'
    ...
    void "Test the show action with a valid id"() {
        ...
        model.contrato instanceof Contrato
    }
    ...
    void "Test the update action with an invalid instance"() {
        ...
        request.contentType = FORM_CONTENT_TYPE
        request.method = 'PUT'
        controller.update(new Contrato())
