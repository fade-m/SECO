...
<html>
    ...
    <body>
        ...
        <div id="show-cuenta" class="content scaffold-show" role="main">
            ...
            <f:display bean="cuenta" />
            <g:form resource="${this.cuenta}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.cuenta}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
