...
<div class="container">
    ...
    <div class="row m-y-2">
                                                                ...
                                                                <div class="modal-body">
                                                                    <g:form action="ticket" method="POST">
                                                                        ...
                                                                        <div class="form-row">
                                                                            <div class="form-group col-md-6">
                                                                                <label>Abonar </label>
                                                                                <input class="form-control" name="pagoRealizado" type="number" onchange="getCostoFinal(this,${it.id})" value="${it.paquete.precio}">
                                                                            </div>
                                                                            <div class="form-group col-md-6">
                                                                                <label >Total a pagar</label>
                                                                                <input class="form-control" name="" id="costoTotal${it.id}" type="number" value="${mx.com.ironsoft.Pago.getCostoFinal(it.paquete.precio)}" readonly>
                                                                            </div>
                    ...
                    <table class="table table-hover table table-hover table-responsive-xl table-responsive-md table-responsive-sm table-responsive-lg" id="dataTable2">
                        ...
                        <tr>
                            ...
                            <sec:ifAnyGranted roles="ROLE_ADMIN">
                                <th scope="col" class="text-center">Pago de servicio</th>
                                <th scope="col" class="text-center">Pago Ironsoft</th>
                        ...
                        <g:each in="${cuenta?.contratos}" var="contrato">
                            <g:each in="${contrato?.pagos}" var="pago">
                                <tr>
                                    ...
                                    <sec:ifAnyGranted roles="ROLE_ADMIN">
                                        <td class="text-center">${pago.costoInicial}</td>
                                        <td class="text-center">${pago.porcentajeIronSoft}</td>
                                        <td class="text-center">${pago.porcentajeEmpresario}</td>
                                    </sec:ifAnyGranted>
        ...
        <script>
            function getCostoFinal(evt,id){
                var costoInicial=parseInt(evt.value);
                var porcentajeIronSoft = 0.05;
                var porcentajeEmpresario = 0.1;

                var costoFinal =  (( porcentajeIronSoft + porcentajeEmpresario ) * costoInicial) + costoInicial;
                
                $('#costoTotal'+id).val(costoFinal);
                //alert($('#costoTotal'+id).val());
            }
            $(function () {
